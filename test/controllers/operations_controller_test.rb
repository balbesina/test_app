...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { amount: @operation.amount, comment: @operation.comment, is_income: @operation.is_income }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { amount: @operation.amount, comment: @operation.comment, is_income: @operation.is_income }
    assert_redirected_to operation_path(assigns(:operation))
  end
